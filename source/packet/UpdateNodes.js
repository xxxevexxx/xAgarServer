...
UpdateNodes.prototype.build = function() {
    ...
    // Destroyed nodes are written twice: killer/node pair first, node id again in the final delete list.
    ...
    for (var i = 0; i < this.nodes.length; i++) {
        ...
        view.setUint16(offset + 4, x, true); // X position
        view.setUint16(offset + 6, y, true); // Y position
